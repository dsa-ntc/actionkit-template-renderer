...
from mydsa.settings import STATIC_ROOT
from mydsa.views import (event_api_moveon_fake, event_search_results, index,
                         index_db, login_context, logout, user_password_forgot)
