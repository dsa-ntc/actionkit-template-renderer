...
# table replicates core django auth.User model, using that one instead
...
class TextingAdminReplyMessage(models.Model):
    ...
    admin_user = models.ForeignKey(User, models.DO_NOTHING)
...
class CoreUpload(models.Model):
    ...
    updated_at = models.DateTimeField()
    path = models.CharField(max_length=255)
    submitter = models.ForeignKey(User, models.DO_NOTHING, blank=True, null=True)
    page = models.ForeignKey(CorePage, models.DO_NOTHING)
    started_at = models.DateTimeField(blank=True, null=True)
    finished_at = models.DateTimeField(blank=True, null=True)
    rate = models.FloatField(blank=True, null=True)
...
class CoreUserStaffNote(models.Model):
    ...
    updated_at = models.DateTimeField()
    user = models.ForeignKey(CoreUser, models.DO_NOTHING)
    staff = models.ForeignKey(User, models.DO_NOTHING, related_name="staff_note")
...
class CmsUserFormField(models.Model):
    created_at = models.DateTimeField()
    updated_at = models.DateTimeField()
    form_type = models.ForeignKey(ContentType, models.DO_NOTHING)
...
class CoreSupportContact(models.Model):
    ...
    updated_at = models.DateTimeField()
    hidden = models.IntegerField()
    contact = models.ForeignKey(User, models.DO_NOTHING)
